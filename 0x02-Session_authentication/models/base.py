...
class Base():
    ...
    def __eq__(self, other: TypeVar('Base')) -> bool:
        """jhbk dscbjkhb kjhdsc kjhbjkh bdsc"""
    ...
    def to_json(self, for_serialization: bool = False) -> dict:
        """jhjb sdc kj kljnlsdcn kjnlkdsc"""
        result = {}
    ...
    def load_from_file(cls):
        """jhbs dchbjkhbkjbhsd cjhhbk bdjbhc ds"""
    ...
    def save_to_file(cls):
        """jhbk sdbcjhbkjhbdsc jhbjhb cshj"""
        s_class = cls.__name__
        file_path = ".db_{}.json".format(s_class)
        objs_json = {}
    ...
    def save(self):
        """jhjhbds hjbj sdlckjb lkjnlksdc"""
    ...
    @classmethod
    def count(cls) -> int:
        """jhjsd cjhbkjb hkjsdhcb hbkbdsb chj"""
        s_class = cls.__name__
        return len(DATA[s_class].keys())

    @classmethod
    def all(cls) -> Iterable[TypeVar('Base')]:
        """hdsb kjbdsbc ljbsdcknlkjn ds"""
        return cls.search()

    @classmethod
    def get(cls, id: str) -> TypeVar('Base'):
        """jhjbsd kjhbk jdshbc hjbkdscb khds"""
        s_class = cls.__name__
        return DATA[s_class].get(id)

    @classmethod
    def search(cls, attributes: dict = {}) -> List[TypeVar('Base')]:
        """dsjhb jhbdsk cbjhb kjhb dksbhc kjsdh"""
        s_class = cls.__name__
        def _search(obj):
            if len(attributes) == 0:
                return True
